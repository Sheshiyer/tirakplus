# TP-CUST-005: card and panel rules
...
Verified Card, Panel, account, profile, inquiry, and Muse chart surfaces use restrained borders/elevation and avoid nested decorative card structures for page sections.
