# TP-CUST-046 Evidence: Local Guidance Page

## Responsive Screenshot/Contract Proof
- Route: `/experiences/local-guidance` via `src/app/pages/ExperiencePage.tsx`.
- API rail: Context cards come from `GET /api/public/experiences?category=local-guidance`.
