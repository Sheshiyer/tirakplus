# TP-CUST-002: color token implementation
...
Verified Porcelain, Pearl, Charcoal, Soft Slate, Rose Bronze, Night Plum, Trust Green, Warning Clay, and Risk Fig tokens exist and are used for product states.
