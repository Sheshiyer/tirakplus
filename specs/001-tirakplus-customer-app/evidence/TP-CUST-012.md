# TP-CUST-012: icon sheet extraction plan
...
Verified docs/design/asset-usage.md records icon family sheet usage as guidance only and requires extracted/regenerated transparent icons before production use.
