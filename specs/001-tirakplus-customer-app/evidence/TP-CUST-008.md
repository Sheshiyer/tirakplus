...
Verified Input, Select, Textarea, Checkbox and auth/inquiry/account forms use labels, helper/error copy, focus-visible styling, and 44px+ touch targets.
