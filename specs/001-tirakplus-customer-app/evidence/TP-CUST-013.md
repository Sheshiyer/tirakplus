# TP-CUST-013: brand board staging guide
...
Verified docs/design/asset-usage.md and docs/design/visual-reference-qa.md distinguish reference boards from production assets and block text/crop leakage.
