# TP-CUST-001: DESIGN.md token audit
...
Verified design tokens are declared in src/app/design-tokens.css and consumed through src/app/styles.css. Palette, type scale, elevation, focus, and responsive values align with DESIGN.md.
