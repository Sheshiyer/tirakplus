# TP-CUST-043 Evidence: Island Explorer Experience Page

## Responsive Screenshot/Contract Proof
- Route: `/experiences/island-explorer` via `src/app/pages/ExperiencePage.tsx`.
- API rail: Context cards come from `GET /api/public/experiences?category=island-explorer`.
