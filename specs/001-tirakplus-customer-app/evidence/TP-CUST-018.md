# TP-CUST-018: responsive view matrix auth
...
Verified auth login/verify flows use centered single-column panels, touch-safe controls, error states, and dev QA access without replacing production rails.
