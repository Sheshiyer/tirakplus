...
Verified FeedbackState, SkeletonCard, SkeletonProfile, loading/error/empty states, and API error envelopes are present across public, traveller, companion, and account flows.
