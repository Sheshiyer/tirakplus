# TP-CUST-007: profile card rules
...
Verified CompanionPreviewCard uses API-shaped profile data, verification state, availability context, editorial portrait crop, and no rating/swipe mechanics.
